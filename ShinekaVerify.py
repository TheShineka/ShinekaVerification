...
from ShinekaVerification.markup_maker import MakeCaptchaMarkup
...
async def start_handler(_, event: Message):
    await event.reply_text("**ʜᴇʟʟᴏ sᴡᴇᴇᴛ ʜᴇᴀʀᴛ ɪ ᴀᴍ Shineka ᴠᴇʀɪғɪᴄᴀᴛɪᴏɴ ʙᴏᴛ ᴛᴏ ᴠᴇʀɪғʏ ᴛʜᴇ ɴᴇᴡ ɢʀᴏᴜᴘ ᴍᴇᴍʙᴇʀs ɪɴ ᴛᴇʟᴇɢʀᴀᴍ**👻\n\n**ɢɪᴠᴇ ᴍᴇ ʜᴇᴀʀᴛ** [Shineka](https://t.me/Shinekabot) [Support](t.me/Aviesupport) **ᴛʜᴀɴᴋs ғᴏʀ ᴜsɪɴɢ**.", disable_web_page_preview=True)
